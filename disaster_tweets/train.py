...
import torch
import numpy as np
import disaster_tweets.data_loader.data_loaders as module_data
import disaster_tweets.model.loss as module_loss
import disaster_tweets.model.metric as module_metric
import disaster_tweets.model.model as module_arch
from disaster_tweets.parse_config import ConfigParser
...
def main(config):
    ...
    # setup data processor instances
    ...
    data_loader = config.init_obj(
        "train_data_loader", module_data, dataset=train_dataset
    )
    valid_data_loader = config.init_obj(
        "val_data_loader", module_data, dataset=val_dataset
    )
